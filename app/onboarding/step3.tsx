  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Real-Time Market Data</Text>
        <Text style={styles.description}>
          Access real-time market data, track major indices, and monitor your
          portfolio performance with professional-grade analytics and reporting.
        </Text>
